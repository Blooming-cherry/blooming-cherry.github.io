...
(function(){
  var playlist = [
    {cid:"125030",name:"祭祷",artist:"塞壬唱片-MSR",url:"https://res01.hycdn.cn/03dd7c3860c0172b3d80588eea18e244/6A12AB45/siren/audio/20260507/52f3bff5a12d1c2a30144258aa919d8c.wav",cover:"https://web.hycdn.cn/siren/pic/20260501/41a1c9bddfb88bc10ab7f131aa956dc2.jpg",album:"相变临界OST"},
    {cid:"125031",name:"无缚者之夜",artist:"塞壬唱片-MSR",url:"https://res01.hycdn.cn/2a84339784c2d8b13348abd30fb35002/6A12AB4B/siren/audio/20260408/91951c176c1620e58f98a7fa242f6024.wav",cover:"https://web.hycdn.cn/siren/pic/20260408/500f5ad502b8e088d154343c83bf2277.png",album:"人们，我们OST"},
    {cid:"125032",name:"破晦",artist:"塞壬唱片-MSR",url:"https://res01.hycdn.cn/14bd9640624342a48408a872e36c8d5d/6A12AAFB/siren/audio/20260323/c4a61ece7880e5c470f74a7fd6ca61ca.wav",cover:"https://web.hycdn.cn/siren/pic/20260323/5bf6f1151f4b12c0d6d6ccd47598372a.jpg",album:"岁的界园志异OST"},
    {cid:"125033",name:"盘桓千古",artist:"塞壬唱片-MSR",url:"https://res01.hycdn.cn/dd3a4259ccd26efb15c56c3a1441601e/6A12AAF7/siren/audio/20260323/9dc16b5b090fa0e63a2ed06c6b6a759c.wav",cover:"https://web.hycdn.cn/siren/pic/20260323/5bf6f1151f4b12c0d6d6ccd47598372a.jpg",album:"岁的界园志异OST"},
    {cid:"125034",name:"Oath (Instrumental)",artist:"塞壬唱片-MSR",url:"https://res01.hycdn.cn/1d5193c07e0f0739456242d566d05442/6A12AB4E/siren/audio/20260310/dfe186e74eb778bac0bd07e4184cc13e.wav",cover:"https://web.hycdn.cn/siren/pic/20260310/21165f7bd3a083aff3a14f10e8f14dbf.jpg",album:"Oath"}
  ];
  ...
  function loadTrack(i){
    ...
    document.querySelectorAll('.vinyl-playlist-item').forEach(function(el,j){el.classList.toggle('active',j===i)});
  ...
  function setPlaying(p){
    isPlaying=p;
    if(p){disc.classList.add('vinyl-spinning');tonearm.classList.add('playing');playIcon.style.display='none';pauseIcon.style.display='block'}
    else{disc.classList.remove('vinyl-spinning');tonearm.classList.remove('playing');playIcon.style.display='block';pauseIcon.style.display='none'}
  }

  function nextTrack(){loadTrack((curIdx+1)%playlist.length)}
  function prevTrack(){loadTrack((curIdx-1+playlist.length)%playlist.length)}
  ...
  audio.addEventListener('error',function(){console.error('Audio error:',audio.error);setPlaying(false)});
  ...
  playlist.forEach(function(t,i){
    ...
    item.addEventListener('click',function(){loadTrack(i);if(!isPlaying){togglePlay()}});
    plEl.appendChild(item);
  });

  // Auto-play first track
  loadTrack(0);
  audio.play().then(function(){setPlaying(true)}).catch(function(e){console.log('Autoplay blocked:',e.message);setPlaying(false)});
